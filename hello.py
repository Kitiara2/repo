...
with st.echo(code_location='below'):
    ...
    for year in list(set(df_years["harvest_year"])):
        ...
        df_years_selection
        trace_list.append(go.Scatter(visible=False, x=df_years_selection['Flavor'], y=df_years_selection['Aroma'], mode='markers', name = "cups", marker=dict(color = "lightgreen" if species == 'Arabica' else "lightblue", size=20*df_years_selection['Clean_Cup'])))

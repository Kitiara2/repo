...
with st.echo(code_location='below'):
    ...
    for year in list(set(df_years["harvest_year"])):
        ...
        trace_list.append(go.Scatter(visible=False, x=df_years_selection['Flavor'], y=df_years_selection['Aroma'], mode='markers', name = "cups", marker=dict(color = "lightgreen" if df_years_selection == 'Arabica' else "lightblue", size=4*df_years_selection['Clean_Cup'])))

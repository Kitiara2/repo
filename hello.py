...
#    df = df_ro
    ...
    df_selection = df.groupby(["Country_of_Origin", "harvest_year"]).agg({'Clean_Cup':'sum', 'Aroma' : 'mean', 'Flavor' : 'mean', 'Aflertaste' : 'mean', 'Acidity' : 'mean', 'Body' : 'mean', 'Balance' : 'mean', 'Species' : 'unique', 'Owner' : 'unique'}).reset_index()
